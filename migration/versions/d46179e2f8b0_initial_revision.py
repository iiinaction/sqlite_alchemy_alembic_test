...
Revision ID: d46179e2f8b0
Revises: 
Create Date: 2025-03-03 14:33:28.006950
...
def upgrade() -> None:
    ...
    sa.Column('interests', sa.JSON(sa.String()), nullable=True),
    ...
    sa.Column('photos_url', sa.JSON(sa.String()), nullable=True),
